    ...
    setExtendedPurchases((prev) => {
      ...
      return (
        purchasesInCart?.map((purchase) => {
          const isChoosenPurchase = choosenPurchaseIdFromLocation === purchase._id
          return {
            ...purchase,
            disabled: false,
            checked: isChoosenPurchase || Boolean(extendedPurchasesObject[purchase._id]?.checked)
          }
        }) || []
      )
    })
      ...
      <div className='container'>
        {extendedPurchases.length > 0 ? (
          ...
          <div className='text-center'>
            ...
            <div className='mt-5'>
              <Link to={path.home} className='rounded-sm bg-orange px-10 py-3 uppercase text-white hover:bg-orange/80'>
                Mua ngay
              </Link>
            </div>
          </div>
